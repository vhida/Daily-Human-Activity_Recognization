...
#        with open("../data/processed_data.csv", 'a') as file:
        ...
        print filecsv.shape
        np.savetxt("../data/processed_data.csv", filecsv, delimiter=",")
...
#        
        ...
        rs = np.concatenate((mins,maxs,means,stds,mads, kurtosis, maxfreq, corr),axis=0)
#        rs = np.concatenate((mins,maxs,means,stds,mads,maxfreq,corr,skew),axis=0)
        return rs
